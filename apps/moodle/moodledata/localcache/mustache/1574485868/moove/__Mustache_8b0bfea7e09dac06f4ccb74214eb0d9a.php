...
class __Mustache_8b0bfea7e09dac06f4ccb74214eb0d9a extends Mustache_Template
{
...
';
        // 'categories' section
        $value = $context->find('categories');
        $buffer .= $this->section0f2897aa09d4c94fa772ecfb2695cb3f($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section14e3eb5106e6047117fc12b4f3da14f2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $value = $this->resolveValue($context->find('editfieldurl'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" data-role="editfield">';
                // 'pix' section
                $value = $context->find('pix');
...
';
    ...
    private function section0f2897aa09d4c94fa772ecfb2695cb3f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section14e3eb5106e6047117fc12b4f3da14f2($context, $indent, $value);
